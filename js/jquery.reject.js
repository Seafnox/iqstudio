    ...
    $.reject = function(options) {
        var opts = $.extend(true,{
            ...
            browserInfo: { // Settings for which browsers to display
                firefox: {
                    text: 'Firefox 22', // Text below the icon
            ...
            // Paragraph 1
            paragraph1: 'Вы пользуетесь устаревшим браузером, который не поддерживает '+
                'современные веб-стандарты и представляет угрозу вашей '+
                'безопасности.',
            // Paragraph 2
